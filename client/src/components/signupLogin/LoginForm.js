...
class LoginForm extends Component {
  ...
  async postLogin(values) {
    ...
    //if login is success redirect to the booking page
    if (success) {
      this.props.updateUser(user);
      return this.props.history.push("/home")
    }

    //if login is unsuccessful rerender with error message
  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit(this.postLogin.bind(this))}>
...
const mapped = connect(null, actions)(LoginForm);
